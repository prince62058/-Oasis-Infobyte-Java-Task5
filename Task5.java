...
class Task5{
    ...
    public void admin_login()
    {
        ...
        loginto.put("Prince",525252);
        loginto.put("Prince2",525252);
    ...
    public void user_login()
    {
        ...
        int password = sc.nextInt();
        loginto.put("Prince",525252);
        loginto.put("Rahul",20026);
        loginto.put("Yashasvee",12345);
        loginto.put("Ritesh",24680);
        loginto.put("Kunal",11111);
    ...
    {
        System.out.println("--------------------------------------------------------");
        System.out.println("----- Digital Library ---> Welcome Admin " + Task5.userID + "! ----");
    ...
    {
        System.out.println("--------------------------------------------------------");
        System.out.println("----- Digital Library ---> Welcome User " + Task5.userID + "! -----");
